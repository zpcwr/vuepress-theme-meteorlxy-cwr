...
module.exports = (opts, ctx) => {
  ...
  if (typeof opts.base === 'undefined') opts.base = ctx.siteConfig.base ? ctx.siteConfig.base.substr(0, ctx.siteConfig.base.length - 1) : ''
  ...
  const { comments, lang, defaultPages, base } = opts

  const options = {
    name: 'vuepress-theme-meteorlxy',

    plugins: [
      [require('./plugins/blog'), { lang, base }],
